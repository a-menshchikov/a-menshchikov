...
- [redis/go-redis](https://github.com/redis/go-redis) ([v9.11.0](https://github.com/redis/go-redis/releases/tag/v9.11.0), 2 weeks ago) - Redis Go client
...
- [Generate code marker according golang docs](https://github.com/tinylib/msgp/pull/397) on [tinylib/msgp](https://github.com/tinylib/msgp) (1 week ago)
