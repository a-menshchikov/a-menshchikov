...
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.5.6](https://github.com/nbgrp/auditor/releases/tag/v0.5.6), 5 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([v3.0.3](https://github.com/web-token/jwt-framework/releases/tag/v3.0.3), 5 days ago) - JWT Framework
