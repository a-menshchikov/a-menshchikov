...
- [phpro/grumphp](https://github.com/phpro/grumphp) - A PHP code-quality tool (2 days ago)
...
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.5.0](https://github.com/nbgrp/auditor/releases/tag/v0.5.0), 2 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
...
- [[Contracts] EventDispatcherInterface phpdocs improvement for static analyze](https://github.com/symfony/symfony/pull/45381) on [symfony/symfony](https://github.com/symfony/symfony) (1 day ago)
- [New `no-dev` option for local-php-security-checker](https://github.com/phpro/grumphp/pull/984) on [phpro/grumphp](https://github.com/phpro/grumphp) (2 days ago)
