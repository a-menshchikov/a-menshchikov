...
- [tinylib/msgp](https://github.com/tinylib/msgp) ([v1.6.1](https://github.com/tinylib/msgp/releases/tag/v1.6.1), 1 day ago) - A Go code generator for MessagePack / msgpack.org[Go]
- [redis/go-redis](https://github.com/redis/go-redis) ([v9.18.0-beta.1](https://github.com/redis/go-redis/releases/tag/v9.18.0-beta.1), 3 days ago) - Redis Go client
- [max-messenger/max-bot-api-client-go](https://github.com/max-messenger/max-bot-api-client-go) ([v1.3.0](https://github.com/max-messenger/max-bot-api-client-go/releases/tag/v1.3.0), 4 days ago)
