...
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.6.1](https://github.com/nbgrp/auditor/releases/tag/v0.6.1), 5 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
...
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([v3.0.4](https://github.com/web-token/jwt-framework/releases/tag/v3.0.4), 4 weeks ago) - JWT Framework
...
- [Use `AsCommand` attribute to prevent Symfony 6.1 deprecations](https://github.com/web-token/jwt-framework/pull/341) on [web-token/jwt-framework](https://github.com/web-token/jwt-framework) (5 days ago)
