...
- [nbgrp/singlea](https://github.com/nbgrp/singlea) ([v2.0.0](https://github.com/nbgrp/singlea/releases/tag/v2.0.0), today) - SingleA is a true SSO service based on the SingleAuth authentication framework
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.24.0](https://github.com/nbgrp/auditor/releases/tag/v0.24.0), today) - Simple and useful dockerized GrumPHP-based php code analyzer.
