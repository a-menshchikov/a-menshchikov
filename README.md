...
- [nbgrp/singlea](https://github.com/nbgrp/singlea) ([v2.0.0](https://github.com/nbgrp/singlea/releases/tag/v2.0.0), 1 day ago) - SingleA is a true SSO service based on the SingleAuth authentication framework
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.24.0](https://github.com/nbgrp/auditor/releases/tag/v0.24.0), 1 day ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
- [nbgrp/env-bundle](https://github.com/nbgrp/env-bundle) ([v3.0.0](https://github.com/nbgrp/env-bundle/releases/tag/v3.0.0), 4 days ago) - Bundle with a few useful Symfony environment variable processors.
