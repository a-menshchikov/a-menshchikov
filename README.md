...
- [nbgrp/env-bundle](https://github.com/nbgrp/env-bundle) ([v2.1.2](https://github.com/nbgrp/env-bundle/releases/tag/v2.1.2), 3 days ago) - Bundle with a few useful Symfony environment variable processors.
- [nochlezhka/mks](https://github.com/nochlezhka/mks) ([2.5.2](https://github.com/nochlezhka/mks/releases/tag/2.5.2), 3 days ago) - «МКС» (многофункциональный кабинет соцработника) — CRM-система для организации сопровождения клиентов и учета оказанных услуг, а также для сбора статистики. Проект благотворительной организации «Ночлежка». https://homeless.ru/
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.20.0](https://github.com/nbgrp/auditor/releases/tag/v0.20.0), 4 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
...
- [fix: max-width для логотипа на входе](https://github.com/nochlezhka/mks/pull/121) on [nochlezhka/mks](https://github.com/nochlezhka/mks) (2 days ago)
- [fix: обязательное поле &#34;Тип&#34; в Отчётах](https://github.com/nochlezhka/mks/pull/120) on [nochlezhka/mks](https://github.com/nochlezhka/mks) (2 days ago)
- [Minor improvements](https://github.com/nbgrp/env-bundle/pull/12) on [nbgrp/env-bundle](https://github.com/nbgrp/env-bundle) (3 days ago)
- [Minor improvements](https://github.com/nbgrp/env-bundle/pull/11) on [nbgrp/env-bundle](https://github.com/nbgrp/env-bundle) (3 days ago)
- [fix: invalid report dates and unexpected report type](https://github.com/nochlezhka/mks/pull/119) on [nochlezhka/mks](https://github.com/nochlezhka/mks) (3 days ago)
- [Update static analyse rules (2.x)](https://github.com/nbgrp/env-bundle/pull/10) on [nbgrp/env-bundle](https://github.com/nbgrp/env-bundle) (3 days ago)
- [Update static analyse rules](https://github.com/nbgrp/env-bundle/pull/9) on [nbgrp/env-bundle](https://github.com/nbgrp/env-bundle) (3 days ago)
- [04-10-2023 fixes and updates](https://github.com/nochlezhka/mks/pull/118) on [nochlezhka/mks](https://github.com/nochlezhka/mks) (3 days ago)
