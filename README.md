...
- [nbgrp/singleid-nginx-lua](https://github.com/nbgrp/singleid-nginx-lua) - Lua module for nginx that implements SingleID client (3 weeks ago)
...
- [nbgrp/singleid-redis](https://github.com/nbgrp/singleid-redis) ([v0.5.0](https://github.com/nbgrp/singleid-redis/releases/tag/v0.5.0), 3 days ago) - SingleID persistence implementation for Redis
- [nbgrp/singleid-payload](https://github.com/nbgrp/singleid-payload) ([v0.5.0](https://github.com/nbgrp/singleid-payload/releases/tag/v0.5.0), 3 days ago) - SingleID payload services implementation
- [nbgrp/singleid-jwt](https://github.com/nbgrp/singleid-jwt) ([v0.5.0](https://github.com/nbgrp/singleid-jwt/releases/tag/v0.5.0), 3 days ago) - SingleID tokenization layer implementation for JWT
- [nbgrp/singleid-contracts](https://github.com/nbgrp/singleid-contracts) ([v0.5.0](https://github.com/nbgrp/singleid-contracts/releases/tag/v0.5.0), 3 days ago)
