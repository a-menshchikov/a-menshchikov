...
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.5.0](https://github.com/nbgrp/auditor/releases/tag/v0.5.0), 1 day ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
...
- [New `no-dev` option for local-php-security-checker](https://github.com/phpro/grumphp/pull/984) on [phpro/grumphp](https://github.com/phpro/grumphp) (1 day ago)
