...
- [nbgrp/env-bundle](https://github.com/nbgrp/env-bundle) ([v3.0.0](https://github.com/nbgrp/env-bundle/releases/tag/v3.0.0), 3 days ago) - Bundle with a few useful Symfony environment variable processors.
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.23.1](https://github.com/nbgrp/auditor/releases/tag/v0.23.1), 3 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
- [nbgrp/singlea](https://github.com/nbgrp/singlea) ([v1.1.0](https://github.com/nbgrp/singlea/releases/tag/v1.1.0), 1 week ago) - SingleA is a true SSO service based on the SingleAuth authentication framework
