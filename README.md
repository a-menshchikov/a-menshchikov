...
- [nbgrp/onelogin-saml-bundle](https://github.com/nbgrp/onelogin-saml-bundle) ([v3.0.0](https://github.com/nbgrp/onelogin-saml-bundle/releases/tag/v3.0.0), 1 day ago) - OneLogin SAML Symfony Bundle
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.31.2](https://github.com/nbgrp/auditor/releases/tag/v0.31.2), 1 day ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
- [max-messenger/max-bot-api-client-go](https://github.com/max-messenger/max-bot-api-client-go) ([v1.2.0](https://github.com/max-messenger/max-bot-api-client-go/releases/tag/v1.2.0), 1 day ago)
- [redis/go-redis](https://github.com/redis/go-redis) ([v9.17.1](https://github.com/redis/go-redis/releases/tag/v9.17.1), 2 days ago) - Redis Go client
