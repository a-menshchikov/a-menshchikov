...
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([v3.0.6](https://github.com/web-token/jwt-framework/releases/tag/v3.0.6), 4 days ago) - JWT Framework
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.9.0](https://github.com/nbgrp/auditor/releases/tag/v0.9.0), 6 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
