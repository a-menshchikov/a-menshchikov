...
- [redis/go-redis](https://github.com/redis/go-redis) ([v9.18.0](https://github.com/redis/go-redis/releases/tag/v9.18.0), 1 day ago) - Redis Go client
- [max-messenger/max-bot-api-client-go](https://github.com/max-messenger/max-bot-api-client-go) ([v1.4.2](https://github.com/max-messenger/max-bot-api-client-go/releases/tag/v1.4.2), 4 days ago)
