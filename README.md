...
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([3.1.2](https://github.com/web-token/jwt-framework/releases/tag/3.1.2), 3 days ago) - JWT Framework
...
- [doctrine/persistence](https://github.com/doctrine/persistence) ([2.5.4](https://github.com/doctrine/persistence/releases/tag/2.5.4), 4 weeks ago) - The Doctrine Persistence project is a library that provides common abstractions for object mapper persistence.
