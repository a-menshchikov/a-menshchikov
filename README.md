...
- [doctrine/persistence](https://github.com/doctrine/persistence) ([2.5.7](https://github.com/doctrine/persistence/releases/tag/2.5.7), 3 days ago) - The Doctrine Persistence project is a library that provides common abstractions for object mapper persistence.
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([3.1.6](https://github.com/web-token/jwt-framework/releases/tag/3.1.6), 4 days ago) - JWT Framework
