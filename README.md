...
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.12.0](https://github.com/nbgrp/auditor/releases/tag/v0.12.0), 4 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
...
- [phan/phan](https://github.com/phan/phan) ([5.4.1](https://github.com/phan/phan/releases/tag/5.4.1), 6 days ago) - Phan is a static analyzer for PHP. Phan prefers to avoid false-positives and attempts to prove incorrectness rather than correctness.
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([3.1.1](https://github.com/web-token/jwt-framework/releases/tag/3.1.1), 1 week ago) - JWT Framework
