...
- [redis/go-redis](https://github.com/redis/go-redis) ([v9.17.2](https://github.com/redis/go-redis/releases/tag/v9.17.2), today) - Redis Go client
- [max-messenger/max-bot-api-client-go](https://github.com/max-messenger/max-bot-api-client-go) ([v1.3.0](https://github.com/max-messenger/max-bot-api-client-go/releases/tag/v1.3.0), today)
