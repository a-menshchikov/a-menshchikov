...
- [nbgrp/recipes](https://github.com/nbgrp/recipes) - Symfony Recipes repository for the nb:group bundles (4 days ago)
...
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([v3.0.4](https://github.com/web-token/jwt-framework/releases/tag/v3.0.4), 2 days ago) - JWT Framework
- [nbgrp/singlea](https://github.com/nbgrp/singlea) ([v0.1.0](https://github.com/nbgrp/singlea/releases/tag/v0.1.0), 5 days ago) - SingleA is a true SSO service based on the SingleAuth authentication framework
