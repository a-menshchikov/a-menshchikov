...
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.30.0](https://github.com/nbgrp/auditor/releases/tag/v0.30.0), 5 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
- [redis/go-redis](https://github.com/redis/go-redis) ([v9.13.0](https://github.com/redis/go-redis/releases/tag/v9.13.0), 5 days ago) - Redis Go client
