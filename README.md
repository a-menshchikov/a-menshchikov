...
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.7.0](https://github.com/nbgrp/auditor/releases/tag/v0.7.0), 3 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
...
- [web-token/jwt-framework](https://github.com/web-token/jwt-framework) ([v3.0.5](https://github.com/web-token/jwt-framework/releases/tag/v3.0.5), 2 weeks ago) - JWT Framework
