...
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.6.1](https://github.com/nbgrp/auditor/releases/tag/v0.6.1), 1 day ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
- [phpro/grumphp](https://github.com/phpro/grumphp) ([v1.12.0](https://github.com/phpro/grumphp/releases/tag/v1.12.0), 3 days ago) - A PHP code-quality tool
...
- [Use `AsCommand` attribute to prevent Symfony 6.1 deprecations](https://github.com/web-token/jwt-framework/pull/341) on [web-token/jwt-framework](https://github.com/web-token/jwt-framework) (1 day ago)
