...
- [nbgrp/singlea-persistence-contracts](https://github.com/nbgrp/singlea-persistence-contracts) - [READ ONLY] Persistence contracts of the SingleA project (5 days ago)
...
- [nbgrp/singlea-feature-config-contracts](https://github.com/nbgrp/singlea-feature-config-contracts) - [READ ONLY] Feature Config contracts of the SingleA project (5 days ago)

---

### 🔭 Latest releases I've contributed to

- [nbgrp/singlea](https://github.com/nbgrp/singlea) ([v1.1.0](https://github.com/nbgrp/singlea/releases/tag/v1.1.0), 4 days ago) - SingleA is a true SSO service based on the SingleAuth authentication framework
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.22.0](https://github.com/nbgrp/auditor/releases/tag/v0.22.0), 5 days ago) - Simple and useful dockerized GrumPHP-based php code analyzer.
