...
- [nbgrp/env-bundle](https://github.com/nbgrp/env-bundle) ([v1.0.2](https://github.com/nbgrp/env-bundle/releases/tag/v1.0.2), 4 days ago)
- [nbgrp/auditor](https://github.com/nbgrp/auditor) ([v0.0.2](https://github.com/nbgrp/auditor/releases/tag/v0.0.2), 4 days ago)
- [phpmd/phpmd](https://github.com/phpmd/phpmd) ([2.10.2](https://github.com/phpmd/phpmd/releases/tag/2.10.2), 4 days ago) - PHPMD is a spin-off project of PHP Depend and aims to be a PHP equivalent of the well known Java tool PMD. PHPMD can be seen as an user friendly frontend application for the raw metrics stream measured by PHP Depend.
- [nbgrp/singleid-redis](https://github.com/nbgrp/singleid-redis) ([v0.0.5](https://github.com/nbgrp/singleid-redis/releases/tag/v0.0.5), 6 days ago)
