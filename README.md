...
- [tinylib/msgp](https://github.com/tinylib/msgp) ([v1.6.4](https://github.com/tinylib/msgp/releases/tag/v1.6.4), 4 days ago) - A Go code generator for MessagePack / msgpack.org[Go]
- [max-messenger/max-bot-api-client-go](https://github.com/max-messenger/max-bot-api-client-go) ([v1.6.14](https://github.com/max-messenger/max-bot-api-client-go/releases/tag/v1.6.14), 5 days ago)
